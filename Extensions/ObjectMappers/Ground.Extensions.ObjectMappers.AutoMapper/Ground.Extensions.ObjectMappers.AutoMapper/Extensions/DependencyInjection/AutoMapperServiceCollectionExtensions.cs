...
using Ground.Extensions.ObjectMappers.AutoMapper.Options;
using Ground.Extensions.ObjectMappers.AutoMapper.Services;
...
namespace Ground.Extensions.DependencyInjection
{
    ...
    {
        public static IServiceCollection AddGroundAutoMapperProfiles(this IServiceCollection services,
                                                              IConfiguration configuration,
                                                              string sectionName)
            => services.AddGroundAutoMapperProfiles(configuration.GetSection(sectionName));

        public static IServiceCollection AddGroundAutoMapperProfiles(this IServiceCollection services, IConfiguration configuration)
        {
