using Ground.Utilities.Authentication.ApiAuthentication.Options;
...
namespace Ground.Extensions.DependencyInjection
{
    ...
    {
        public static IServiceCollection AddGroundApiAuthentication(this IServiceCollection services, IConfiguration configuration, string sectionName)
            => services.AddGroundApiAuthentication(configuration.GetSection(sectionName));

        public static IServiceCollection AddGroundApiAuthentication(this IServiceCollection services, IConfiguration configuration)
        {
        ...
        public static IServiceCollection AddGroundApiAuthentication(this IServiceCollection services, Action<ApiAuthenticationOption> action)
        {
