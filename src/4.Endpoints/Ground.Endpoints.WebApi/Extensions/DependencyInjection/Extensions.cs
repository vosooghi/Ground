...
namespace Ground.Endpoints.WebApi.Extensions.DependencyInjection
{
    public static class Extensions
    {
        ...
        /// <summary>
        /// when there is an interface which doesn't inherit from any existence interfaces, we should implement 
        /// ITransientLifetime or IScopeLifetime or ISingletoneLifetime
        /// </summary>
        /// <param name="services"></param>
